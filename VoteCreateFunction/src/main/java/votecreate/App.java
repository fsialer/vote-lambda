...
public class App implements RequestHandler<APIGatewayProxyRequestEvent, APIGatewayProxyResponseEvent> {
    ...
    public App() {
        this.saveVoteUseCase = saveVoteUseCase();
    }

    protected SaveVoteUseCase saveVoteUseCase() {
    ...
    public APIGatewayProxyResponseEvent handleRequest(APIGatewayProxyRequestEvent apiGatewayProxyRequestEvent, Context context) {
        ...
        try {
            ...
            OptionEvent rq=objectMapper.readValue(body,OptionEvent.class);
            //Validar campos
            Set<ConstraintViolation<OptionEvent>> violations = validator.validate(rq);
            ...
            Long vote=saveVoteUseCase.saveVote(rq.getOptionId());
            saveVoteUseCase.sendMessage(rq);
            // Respuesta exitosa
